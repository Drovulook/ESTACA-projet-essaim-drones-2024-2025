...
multirotorParams.MaxSpeed = 15;               % Vitesse maximale vers l'avant [m/s]
...
fixedWingParams.MinSpeed = 20;                % Vitesse aérienne minimale [m/s] (vitesse de décrochage)
fixedWingParams.MaxSpeed = 50;                % Vitesse aérienne maximale [m/s]
fixedWingParams.CruiseSpeed = 35;             % Vitesse de croisière [m/s]
...
save('params.mat', 'multirotorParams', 'fixedWingParams');
